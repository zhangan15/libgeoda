...
R_swig_new_GeoDaProxy__SWIG_0 ( )
{
  ...
  r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_GeoDaProxy, SWIG_POINTER_OWN |  0 );
  vmaxset(r_vmax);
...
SWIGEXPORT SEXP
R_swig_new_GeoDaProxy__SWIG_1 ( SEXP pDsPath)
{
  GeoDaProxy *result = 0 ;
  char *arg1 = (char *) 0 ;
  int res1 ;
...
SWIGEXPORT SEXP
R_swig_GeoDaProxy_GetValues ( SEXP self, SEXP s_swig_copy)
{
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "GeoDaProxy_GetValues" "', argument " "1"" of type '" "GeoDaProxy *""'"); 
  }
  arg1 = reinterpret_cast< GeoDaProxy * >(argp1);
  result = (arg1)->GetValues();
  r_ans = SWIG_R_NewPointerObj((new std::vector< double >(static_cast< const std::vector< double >& >(result))), SWIGTYPE_p_std__vectorT_double_t, SWIG_POINTER_OWN |  0 );
...
SWIGEXPORT SEXP
R_swig_GeoDaProxy_GetName ( SEXP self, SEXP s_swig_copy)
{
  std::string result;
  GeoDaProxy *arg1 = (GeoDaProxy *) 0 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_GeoDaProxy, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "GeoDaProxy_GetName" "', argument " "1"" of type '" "GeoDaProxy *""'"); 
  }
  arg1 = reinterpret_cast< GeoDaProxy * >(argp1);
  result = (arg1)->GetName();
  r_ans = SWIG_R_NewPointerObj((new std::string(static_cast< const std::string& >(result))), SWIGTYPE_p_std__string, SWIG_POINTER_OWN |  0 );
...
SWIGINTERN R_CallMethodDef CallEntries[] = {
   ...
   {"R_swig_GeoDaProxy_GetName", (DL_FUNC) &R_swig_GeoDaProxy_GetName, 2},
   {"R_swig_GeoDaProxy_GetValues", (DL_FUNC) &R_swig_GeoDaProxy_GetValues, 2},
   {NULL, NULL, 0}
};
